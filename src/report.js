...
const Report = () => {
    ...
    useEffect(() => {
            ...
            window.gapi.client
                .request({
                    ...
                    body: {
                        reportRequests: [
                            {
                                viewId: "243443456", //enter your view ID here
                                dateRanges: [
                                    {
                                        startDate: "10daysAgo",
                                        endDate: "today",
        ...
        const displayResults = (response) => {
            console.log(response.result.reports[0].data.totals[0])
            const queryResult = Array.from(response.result.reports[0].data.rows);
